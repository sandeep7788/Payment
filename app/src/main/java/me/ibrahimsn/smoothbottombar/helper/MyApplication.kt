...
class MyApplication : Application() {
    ...
    companion object {
        ...
        fun setUserId(value: String) {
            mPreferences = getSharedPreferences(myappContext)
            val mEditor = mPreferences!!.edit()
            mEditor.putString(ApiContants.PREF_USER_ID, value)
            mEditor.commit()
        }
        ...
        fun getUserId(): String? {
            return try {
                mPreferences = getSharedPreferences(myappContext)
                mPreferences?.getString(ApiContants.PREF_USER_ID, "")
            } catch (e:Exception){
                null
            }
        }
    ...
    fun writeStringPreference(key: String?, value: String?) {
        mPreferences = Companion.getSharedPreferences(myappContext)
        val mEditor = mPreferences!!.edit()
        mEditor.putString(key, value)
        mEditor.commit()
    }
