...
class BottomSheetBankDialog(var type:String, var bbpsList: ArrayList<BankPojo>?, var onDataPassListener: OnDataPassListener) : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetLayoutBinding
    private var selectedOperator: OperatorPojo? = null
    private var selectedState: CirclePojo? = null
    private var selectedBBps: BankPojo? = null
...
//        }
        ...
        binding.textViewItem.text="Please Select Bank"
        if (bbpsList !=null) {
        ...
        binding.edtOperator.addTextChangedListener(object : TextWatcher {
            override fun onTextChanged(cs: CharSequence, arg1: Int, arg2: Int, arg3: Int) {
                // When user changed the Text
                    ...
                    val filteredList = bbpsList?.filter { it.bank_name.contains(cs, true) } ?: emptyList()
    ...
    inner class BBPSAdapter(private val operators: List<BankPojo>) :
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.textViewItem.text = operator.bank_name
...
//                    startActivityForResult(resultIntent,101)
                onDataPassListener?.onDataPassed(type, selectedBBps?.id.toString(), selectedBBps?.bank_name.toString(),
                    "",""
                    )
                    dismiss()
//                }
